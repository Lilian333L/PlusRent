...
const T = {
  ...
  en: {
    htmlLang: "en",
    ogLocale: "en_US",
    title: (n, y) => `Rent a ${n}${y ? " " + y : ""} in Chisinau: price per day | PlusRent`,
    desc: (n, price, seats, gear) =>
      `Rent a ${n} in Chisinau from €${price} a day. ${seats} seats, ${gear} gearbox, insurance and 200 km a day included, nothing to pay up front. Airport delivery available.`,
    h: "About this car",
    specs: "Specification",
