(function () {
  ...
  var SERVICES = {
    ...
    ru: {
      ...
      items: [
        ...
        { name: 'Трансфер KIV',          sub: 'Кишинёв · 800 MDL',      badge: 'Premium', live: false, url: '/ru/transfer-chisinau' },
        { name: 'Трансфер IAS',          sub: 'Яссы · €140',             badge: 'Premium', live: false, url: '/ru/transfer-iasi'     },
  ...
  function buildDesktopPanel(t, cur) {
    ...
    el.id = 'prDropPanel';
    el.style.cssText = 'position:fixed;z-index:9200;width:480px;background:#1C1917;border-radius:14px;border:1px solid rgba(255,255,255,.10);border-top:2px solid #f59e0b;padding:14px;box-shadow:0 24px 70px rgba(0,0,0,.6),0 4px 20px rgba(0,0,0,.4);opacity:0;pointer-events:none;transform:translateY(-6px);transition:opacity .22s ease,transform .22s ease;box-sizing:border-box;';
