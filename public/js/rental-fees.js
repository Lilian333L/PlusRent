...
(function (root) {
   ...
   * are given it falls back to whole calendar days. GRACE_MINUTES stays at zero
   * unless the business decides to allow a late return before the next day starts.
   */
